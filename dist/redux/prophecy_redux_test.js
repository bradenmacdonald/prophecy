...
describe('Prophecy Redux API', function () {
    ...
    describe('store', () => {
        ...
        const actionSet = [
            ...
            { type: actions.UPDATE_ACCOUNT, id: 20, data: { initialBalance: 100000 } },
            ...
            { type: actions.DELETE_ACCOUNT, id: 30 },
            { type: actions.DELETE_TRANSACTION, id: 1 },
            { type: actions.UPDATE_ACCOUNT, id: 20, index: 0 },
            { type: actions.UPDATE_MULTIPLE_TRANSACTIONS, subActions: [
                    // Group multiple transaction updates together
                    { type: actions.UPDATE_TRANSACTION, id: 3, data: { date: +D `2016-07-03` } },
                    { type: actions.UPDATE_TRANSACTION, id: 4, data: { date: +D `2016-07-04` } },
                    { type: actions.UPDATE_TRANSACTION, id: 4, data: { accountId: 40 } },
                    { type: actions.DELETE_TRANSACTION, id: 3 },
                ] },
        ];
...
//# sourceMappingURL=prophecy_redux_test.js.map